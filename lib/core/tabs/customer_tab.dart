...
class CustomerTab extends StatelessWidget {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: _customerBox("Total Customers", "32", Colors.red)),
              ],
            ),
            Row(
              children: [
                Expanded(child: _customerBox("New Active Customers", "10", Colors.green)),
                const SizedBox(width: 12),
                Expanded(child: _customerBox("New Customers", "7", Colors.orange)),
              ],
            ),
  ...
  Widget _customerBox(String title, String value, Color color) {
    return Container(
