...
class CustomBottomNavBarOwner extends StatelessWidget {
  final int selectedIndex;
  final ValueChanged<int> onTap;

  const CustomBottomNavBarOwner({
    super.key,
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> items = [
      ...
      {
        'label': 'Staff',
        'icon_inactive': 'assets/svg/staff_tipis.svg',
        'icon_active': 'assets/svg/staff_tebal.svg',
      },
      {
        'label': 'Laporan',
        'icon_inactive': 'assets/svg/laporan_tipis.svg',
        'icon_active': 'assets/svg/laporan_tebal.svg',
      },
      {
        'label': 'Profil',
