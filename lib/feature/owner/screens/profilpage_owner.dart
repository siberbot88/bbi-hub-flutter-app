...
class ProfilePageOwner extends StatelessWidget {
  ...
  String _getInitials(String name) {
    if (name.isEmpty) return 'B'; // 'B' untuk Bengkel
  ...
  Widget build(BuildContext context) {
    ...
    // Ambil workshop pertama dari list
    ...
    final String workshopName = workshop?.name ?? user.name; // Fallback ke nama user

    // --- PERUBAHAN DI SINI ---
    // Inisial sekarang diambil dari nama bengkel, bukan nama user
    final String initials = _getInitials(workshopName);
    // --- AKHIR PERUBAHAN ---

    final String workshopEmail =
        workshop?.email ?? user.email; // Fallback ke email user
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          // (Sizing responsif Anda tetap sama)
          ...
          // (Kembali menggunakan SingleChildScrollView)
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // ====== CARD MENU MENGAPUNG (Layout "lama") ======
                Transform.translate(
