...
class ServicePageMechanic extends StatefulWidget {
  const ServicePageMechanic({super.key});

  @override
  State<ServicePageMechanic> createState() => _ServicePageMechanicState();
}

class _ServicePageMechanicState extends State<ServicePageMechanic> {
