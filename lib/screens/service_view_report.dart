...
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
// import 'package:bengkel_online_flutter/screens/custom_header.dart';
import 'package:bengkel_online_flutter/widgets/assign_dialog.dart';
import 'package:bengkel_online_flutter/screens/service_logging.dart';
import 'package:bengkel_online_flutter/screens/service_detail.dart';
...
class _ServicePageState extends State<ServicePage> {
  ...
  bool _matchesFilterKey(Map<String, dynamic> t, String filterKey) {
    ...
    return (t['status'] as String).toLowerCase() ==
  ...
  Widget _scheduledList() {
    ...
    return Padding(
      ...
      child: scheduled.isEmpty
          ...
          : Column(
              children:
                  scheduled.map((t) => _serviceCardFromMap(context, t)).toList(),
            ),
    );
  }
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _getVehicleBgColor(t['vehicleCategory']).withOpacity(0.2),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Text(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (ctx) => ElevatedButton(
                          ...
                          child: Text(
                            "Tolak",
                            style: GoogleFonts.poppins( // 🔹 pakai poppins
                              fontSize: 14,
                              fontWeight: FontWeight.w600,
                              color: Colors.white,
                            ),
